...
const ASSETS = ['./', './index.html', './manifest.json', './MD_cropped.png', './logo_no_background.png', './logo.png', './background_logo.jpg',
  // logo_hoog staat op de titelpagina van de handleiding. De brede versie en de _op_donker-varianten
  // worden vandaag nergens in de app getoond (de PDF-voettekst zet de naam als tekst, niet als
  // beeld) en horen dus niet in de precache thuis.
  './logo_hoog.png',
