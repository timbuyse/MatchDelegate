// ===================== CONFIG =====================
const APP_VERSION = '1.15.1'; // MAJOR.MINOR.PATCH — 1.0 = uit de testfase, officieel live (23-08-2026)
...
const IC = {
  ...
  // Tabler "eraser" (outline), letterlijk overgenomen — het veld uitvegen en opnieuw opstellen.
  eraser: _svg('<path d="M19 20h-10.5l-4.21 -4.3a1 1 0 0 1 0 -1.41l10 -10a1 1 0 0 1 1.41 0l5 5a1 1 0 0 1 0 1.41l-9.2 9.3"/><path d="M18 13.3l-6.3 -6.3"/>'),
...
const RELEASE_NOTES = {
  '1.15': {
    ...
    punten: [
      ...
      'Hoe je aan die PDF komt, staat stap voor stap op het scherm zelf — die PDF maak je wel op een computer: in ProSoccerData op gsm of tablet is er geen printvenster',
